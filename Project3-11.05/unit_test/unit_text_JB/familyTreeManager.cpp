...
familyTreeManager::familyTreeManager() {
	m_manager = NULL;
	initial = createFamilyTree("a.csv");
}
...
std::vector<treeNode*> familyTreeManager::searchPersonByVersion(int t_version) const {
...
// all his son
std::vector<treeNode*> familyTreeManager::searchFarterAllSon(std::string t_father_name) const {
	// find the guy first
